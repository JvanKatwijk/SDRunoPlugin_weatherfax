...
#include	"fax-bandfilter.h"
	...
	faxBandfilter::faxBandfilter (int16_t firSize,
...
//	windowing, according to Blackman
	...
	faxBandfilter::~faxBandfilter () {
}

std::complex<float>
	faxBandfilter::Pass (std::complex<float> z) {
int16_t	i;
...
void	faxBandfilter::update	(int shift, int width) {
	(void)width;
