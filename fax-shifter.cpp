...
#include	<math.h>
	...
	faxShifter::faxShifter	(int32_t size) {
int i;
	this	->tableSize	= size;
	phase			= 0;
	...
	faxShifter::~faxShifter	() {
	delete[] table;
}

void	faxShifter::do_shift	(std::complex<float>	*buffer,
	                         int32_t	bufLen,
	                         int32_t	freq) {
...
std::complex<float>
	faxShifter::do_shift	(std::complex<float> z, int32_t freq) {
